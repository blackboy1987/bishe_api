...
public final class WebUtils {
	...
	static {
		...
		RequestConfig requestConfig = RequestConfig.custom().setConnectionRequestTimeout(Timeout.ofDays(60000)).setConnectTimeout(Timeout.ofDays(60000)).build();
	...
	public static String post(String url, String xml) {
		...
		return post(url, null, new StringEntity(xml, StandardCharsets.UTF_8));
	}
	...
	public static String post(String url, Map<String, Object> parameterMap) {
        ...
        return post(url, null, new UrlEncodedFormEntity(nameValuePairs, StandardCharsets.UTF_8));
    }
